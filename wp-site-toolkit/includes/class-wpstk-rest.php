...
class WPSTK_Rest {
	 ...
	 * REST namespace.
	 */
	const NAMESPACE_ROOT = 'wp-site-toolkit/v1';
	...
	public static function can_view() {
		...
		return new WP_Error(
			'wpstk_forbidden',
			__( 'You do not have permission to read WP Site Toolkit results.', 'wp-site-toolkit' ),
	...
	public static function get_scan( $request ) {
		...
		if ( ! $scan ) {
			return new WP_Error(
				...
				__( 'That scan could not be found.', 'wp-site-toolkit' ),
				array( 'status' => 404 )
			);
		}
