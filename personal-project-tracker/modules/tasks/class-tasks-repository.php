...
class PTP_Tasks_Repository {
	 ...
	 * @return array<int, array{total: int, completed: int, in_progress: int, overdue: int, completion_rate: float|null, by_status: array<string,int>}> Keyed by project_id; a project with no matching tasks is still present with all-zero counts.
	 */
