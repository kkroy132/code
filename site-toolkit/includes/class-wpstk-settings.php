...
class WPSTK_Settings {
	...
	public static function register() {
		...
		add_settings_section(
			...
			__( 'Monitoring and history', 'site-toolkit' ),
		...
		$fields = array(
			array(
				'id'      => 'scan_timeout',
				'title'   => __( 'Request timeout', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 2,
				'max'     => 30,
				'suffix'  => __( 'seconds', 'site-toolkit' ),
				'help'    => __( 'How long the scanner waits for a single URL before giving up.', 'site-toolkit' ),
			),
			array(
				'id'      => 'max_urls',
				'title'   => __( 'Maximum URLs per scan', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 10,
				'max'     => 2000,
				'help'    => __( 'Upper limit for link checking. Lower this on shared hosting.', 'site-toolkit' ),
			),
			array(
				'id'      => 'max_posts',
				'title'   => __( 'Maximum posts per scan', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 10,
				'max'     => 5000,
				'help'    => __( 'How many published posts, pages and other public entries are analysed.', 'site-toolkit' ),
			),
			array(
				'id'      => 'page_samples',
				'title'   => __( 'Rendered pages sampled', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 1,
				'max'     => 50,
				'help'    => __( 'Number of pages loaded from your own site to inspect canonical tags, headings and social tags.', 'site-toolkit' ),
			),
			array(
				'id'      => 'batch_posts',
				'title'   => __( 'Posts per batch', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 5,
				'max'     => 200,
				'help'    => __( 'Smaller batches are gentler on the server but make scans take longer.', 'site-toolkit' ),
			),
			array(
				'id'      => 'batch_urls',
				'title'   => __( 'URLs per batch', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 1,
				'max'     => 25,
				'help'    => __( 'How many links are requested in a single scan step.', 'site-toolkit' ),
			),
			array(
				'id'      => 'scan_external',
				'title'   => __( 'Check external links', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'checkbox',
				'label'   => __( 'Send requests to third-party domains linked from your content', 'site-toolkit' ),
				'help'    => __( 'Off by default. When enabled, the scanner contacts the external sites you link to in order to detect dead links. External links are always counted, even when this is off.', 'site-toolkit' ),
			),
			array(
				'id'      => 'large_image_kb',
				'title'   => __( 'Large image threshold', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 50,
				'max'     => 20000,
				'suffix'  => __( 'KB', 'site-toolkit' ),
				'help'    => __( 'Image files above this size are reported.', 'site-toolkit' ),
			),
			array(
				'id'      => 'large_image_dim',
				'title'   => __( 'Large dimension threshold', 'site-toolkit' ),
				'section' => 'wpstk_section_scanning',
				'type'    => 'number',
				'min'     => 500,
				'max'     => 20000,
				'suffix'  => __( 'pixels', 'site-toolkit' ),
				'help'    => __( 'Images wider or taller than this are reported.', 'site-toolkit' ),
			),
			array(
				'id'      => 'monitor_404',
				'title'   => __( '404 monitoring', 'site-toolkit' ),
				'section' => 'wpstk_section_monitoring',
				'type'    => 'checkbox',
				'label'   => __( 'Record requests that end in a 404 page', 'site-toolkit' ),
				'help'    => __( 'Stores the requested path, the referring URL and a hit counter. No IP addresses, user agents or other visitor details are stored.', 'site-toolkit' ),
			),
			array(
				'id'      => 'auto_scan',
				'title'   => __( 'Automatic audits', 'site-toolkit' ),
				'section' => 'wpstk_section_monitoring',
				'type'    => 'select',
				'options' => array(
					'disabled' => __( 'Disabled (run audits manually)', 'site-toolkit' ),
					'weekly'   => __( 'Once a week', 'site-toolkit' ),
					'monthly'  => __( 'Once a month', 'site-toolkit' ),
				),
				'help'    => __( 'Disabled by default. Automatic audits run through WP-Cron in small batches.', 'site-toolkit' ),
			),
			array(
				'id'      => 'retention_days',
				'title'   => __( 'Keep scan history for', 'site-toolkit' ),
				'section' => 'wpstk_section_monitoring',
				'type'    => 'number',
				'min'     => 1,
				'max'     => 3650,
				'suffix'  => __( 'days', 'site-toolkit' ),
				'help'    => __( 'Scans older than this are deleted automatically once a day.', 'site-toolkit' ),
			),
			array(
				'id'      => 'max_scans',
				'title'   => __( 'Maximum stored scans', 'site-toolkit' ),
				'section' => 'wpstk_section_monitoring',
				'type'    => 'number',
				'min'     => 2,
				'max'     => 200,
				'help'    => __( 'Only the most recent scans are kept, whichever limit is reached first.', 'site-toolkit' ),
			),
			array(
				'id'      => 'delete_data',
				'title'   => __( 'Uninstall behaviour', 'site-toolkit' ),
				'section' => 'wpstk_section_data',
				'type'    => 'checkbox',
				'label'   => __( 'Remove all Site Toolkit data when uninstalling', 'site-toolkit' ),
				'help'    => __( 'Off by default. When enabled, deleting the plugin also removes its tables, options and scheduled events. Your posts, pages and media are never touched.', 'site-toolkit' ),
			),
		);
	...
	public static function render_scanning_intro() {
		echo '<p class="description">' . esc_html__( 'These limits keep audits predictable on shared hosting. Increase them if your server has room to spare.', 'site-toolkit' ) . '</p>';
	}
	...
	public static function render_monitoring_intro() {
		echo '<p class="description">' . esc_html__( 'Everything below is processed and stored on this site only.', 'site-toolkit' ) . '</p>';
	}
	...
	public static function render_data_intro() {
		echo '<p class="description">' . esc_html__( 'Control what happens to stored audit data.', 'site-toolkit' ) . '</p>';
	}
