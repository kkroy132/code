...
<h1 class="wpstk-heading">
	...
	<?php echo esc_html__( 'Site Toolkit', 'site-toolkit' ); ?>
...
<?php if ( ! empty( $view['running']['running'] ) && 'audit' !== $wpstk_page['view'] ) : ?>
	<div class="notice notice-info">
		<p>
			<?php echo esc_html__( 'An audit is currently running.', 'site-toolkit' ); ?>
			<a href="<?php echo esc_url( WPSTK_Admin::page_url( 'site-toolkit-audit' ) ); ?>">
				<?php echo esc_html__( 'View progress', 'site-toolkit' ); ?>
			</a>
		</p>
	</div>
<?php endif; 
